...
- 最终 source 重审批次：`20260806T073937Z-886173de`；未创建新的 policy 升级批次，未重复提取或OCR未变化资料。
...
- 正式可用 semantic 14,779 条，source 绑定率 100%；policy 22 份、300 章、319 条有效映射，章节和间接 source 绑定率均为 100%。审核教师仍为谢云琦、孟玮娜、卢明浩；没有合格正式公开材料的新教师不会被新增。
